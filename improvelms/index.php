...
<div class="w3-top">
  <div class="w3-bar w3-white w3-padding w3-card" style="letter-spacing:4px;">
    ...
    <div class="w3-right w3-hide-small">
      ...
      <a href="viewcourse.php" class="w3-bar-item w3-button">ViewCourse</a>
      <!-- <a href="viewuser.php?uid=<?= $instructorId ?>&roleid=1" class="w3-bar-item w3-button">View All Users</a> -->
      ...
      <!-- <a href="viewuser.php" class="w3-bar-item w3-button">ViewUser</a> -->
      <!-- <a href="viewuser.php?uid=<?= $instructorId ?>&roleid=2" class="w3-bar-item w3-button">View All Users</a> -->
